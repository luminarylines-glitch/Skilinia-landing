...
function App() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 via-[#0a0a0a] to-black relative flex flex-col items-center pt-10 pb-20 px-4 sm:px-6 lg:px-8 font-sans selection:bg-emerald-600 selection:text-white overflow-hidden">
            ...
            <div className="relative z-10 text-center w-full max-w-7xl mx-auto mb-12 space-y-8">
                ...
                <motion.p
                    ...
                    className="relative z-20 text-gray-400 font-medium text-sm sm:text-base tracking-[0.2em] uppercase max-w-xl mx-auto border-b border-gray-800/50 pb-8 mb-8"
                >
          ...
          `}
            ...
            <div className="mt-32 w-full max-w-lg mx-auto relative px-4 z-10">
                <p className="text-center text-[9px] font-bold uppercase tracking-[0.4em] text-gray-600 mb-10 font-sans opacity-60">Elite Alumni Results</p>
            ...
            {/* Minimal Footer */}
            <footer className="mt-32 pb-8 text-center text-gray-700 text-[9px] uppercase tracking-[0.3em] font-medium relative z-10">
